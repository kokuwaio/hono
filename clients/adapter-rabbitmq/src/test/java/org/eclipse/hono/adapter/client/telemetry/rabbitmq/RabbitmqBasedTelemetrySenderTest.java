...
/**
 * Verifies behavior of {@link RabbitmqBasedTelemetrySender}.
 */
@ExtendWith(VertxExtension.class)
public class RabbitmqBasedTelemetrySenderTest {
    ...
    public void testSendTelemetryCreatesCorrectRecordWithQoS0(final VertxTestContext ctx) {
        ...
        final RabbitmqBasedTelemetrySender sender = new RabbitmqBasedTelemetrySender(factory, rabbitmqProducerConfig,
    ...
    public void testThatConstructorThrowsOnMissingParameter() {
        ...
        assertThrows(NullPointerException.class,
                () -> new RabbitmqBasedTelemetrySender(null, rabbitmqProducerConfig, adapterConfig, tracer));

        assertThrows(NullPointerException.class,
                () -> new RabbitmqBasedTelemetrySender(factory, null, adapterConfig, tracer));

        assertThrows(NullPointerException.class,
                () -> new RabbitmqBasedTelemetrySender(factory, rabbitmqProducerConfig, adapterConfig, null));
    }

    /**
     * Verifies that
     * {@link RabbitmqBasedTelemetrySender#sendTelemetry(TenantObject, RegistrationAssertion, QoS, String, Buffer, Map, SpanContext)}
